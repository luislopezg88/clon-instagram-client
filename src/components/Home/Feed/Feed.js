...
import { GET_PUBLICATIONs_FOLLOWERDS } from "../../../gql/publication";
import Action from "../../Modal/ModalPublication/Actions";
import CommForm from "../../Modal/ModalPublication/CommForm";
...
export default function Feed() {
    ...
    const {data, loading, startPolling, stopPolling} = useQuery(GET_PUBLICATIONs_FOLLOWERDS);
                ...
                {map(getPublicationsFolloweds, (publication, index) => (
                    <div key={index} className="feed__box">
                        ...
                        <div className="feed__box-form">
                            <CommForm publication={publication} />
                        </div>
